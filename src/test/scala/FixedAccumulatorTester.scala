...
class AccumulatorTester[T <: chisel3.Data](c: Accumulator[T]) extends DspTester(c) {
...
///////////////////////////////////////////////////////////////////////////////////////////
 ...
 /////////////////////////////////////////////////////////////////////////////////////////// 
  ...
  def runTest[T <: Data : Real : BinaryRepresentation](signal: Seq[Double], params: AccParams[T], numWind: Int, accDepth: Int, tol: Int = 3) {
...
object FixedAccumulatorTester {
  def apply(signal: Seq[Double], params: AccParams[FixedPoint], numWind: Int, accDepth: Int, tol: Int = 3, backend: String = "verilator"): Boolean = {
		chisel3.iotesters.Driver.execute(Array("-tbn", backend),
      () => new Accumulator(params)) { c => 
